...
def Densenet(input_shape=None, classes=1000, blocks=[6, 12, 24, 16]):
    include_top = False
    weights = 'imagenet'
    input_tensor = None
    ...
    x = layers.Dropout(0.5, name='dropout')(model.output)
...
if __name__ == '__main__':
    model = Densenet(classes=12, input_shape=(224, 224, 3))
    model.summary()
