# Author  : WangXiao
# File    : resnet18_cbam.py
# Function: 在resnet18中添加cbam模块
...
def ResNet18_CBAM(input_shape=None,
             classes=29):
    """加入cbam模块的Resnet18"""
...
if __name__ == '__main__':
    ...
    model = ResNet18_CBAM(input_shape=[4096, 3000, 3], classes=29)
    model.summary()
    model.save('models/resnet18_cbam.h5')
